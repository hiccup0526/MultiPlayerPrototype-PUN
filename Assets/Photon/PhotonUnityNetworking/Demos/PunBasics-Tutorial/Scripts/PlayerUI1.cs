...
#pragma warning disable 649
	...
	public class PlayerUI1 : MonoBehaviour
	{
		...
		public void SetData(PlayerManager1 _target)
		{
			...
			{
				playerNameText.text = getIndex().ToString() + "-" + this.target.photonView.Owner.NickName;
			}
		}
		...
		public int getIndex()
		{
            ...
            {
                if(player.ActorNumber == this.target.photonView.Owner.ActorNumber)
					return index;
				index++;
            }
			return -1;
