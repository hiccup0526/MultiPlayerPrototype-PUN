...
{
    public class PlayerAnimatorManager1 : MonoBehaviourPun
    {
        ...
        void Update()
        {
            ...
            if (Vector3.Distance(transform.position, hitPosition) > 2f && PlayerManager1.canStart)
            {
                animator.SetFloat("Speed", 1);
            }
            else if (PlayerManager1.canStart)
            {
                PlayerManager1.canStart = false;
